...
export class Nil implements VariantType {
	type = "nil"
}
export class Boolean implements VariantType {
	type = "bool";
	constructor(public value: boolean) { }
}
export class Integer implements VariantType {
	type = "int32";
	constructor(public value: number) { }
}
export class Integer64 implements VariantType {
	type = "int64";
	constructor(public value: bigint) { }
}
export class Float implements VariantType {
	type = "float";
	constructor(public value: number) { }
}
export class Float64 implements VariantType {
	type = "float64";
	constructor(public value: number) { }
}
export class String implements VariantType {
	type = "string";
	constructor(public value: string) { }
}
export class Vector2 implements VariantType {
	type = "vector2";
	x = 0;
	y = 0;
}
export class Vector2i implements VariantType {
	type = "vector2i";
	x = 0;
	y = 0;
}
export class Rect2 implements VariantType {
	type = "rect2";
	position = new Vector2()
	size = new Vector2()
}
export class Rect2i implements VariantType {
	type = "rect2i";
	position = new Vector2i()
	size = new Vector2i()
}
export class Vector3 implements VariantType {
	type = "vector3";
	x = 0;
	y = 0;
	z = 0;
}
export class Vector3i implements VariantType {
	type = "vector3i";
	x = 0;
	y = 0;
	z = 0;
}
export class Vector4 implements VariantType {
	type = "vector4";
	x = 0;
	y = 0;
	z = 0;
...
export class Vector4i implements VariantType {
	type = "vector4i";
	x = 0;
	y = 0;
	z = 0;
...
export class Plane implements VariantType {
	type = "plane";
	normal = new Vector3()
	d = 0;
}
export class Quaternion implements VariantType {
	type = "quaternion";
	x = 0;
	y = 0;
	z = 0;
...
export class AABB implements VariantType {
	type = "aabb";
	position = new Vector3()
	size = new Vector3()
}
export class Transform2D implements VariantType {
	type = "transform2d";
	columns: [Vector2, Vector2, Vector2] = [new Vector2(), new Vector2(), new Vector2()]
}
export class Basis implements VariantType {
	type = "basis";
	rows: [Vector3, Vector3, Vector3] = [new Vector3(), new Vector3(), new Vector3()]
}
export class Transform3D implements VariantType {
	type = "transform3d";
	basis = new Basis();
	origin = new Vector3();
}
export class Projection implements VariantType {
	type = "projection";
	columns: [Vector4, Vector4, Vector4, Vector4] = [new Vector4(), new Vector4(), new Vector4(), new Vector4()]
}
export class Color implements VariantType {
	type = "color";
	r = 0;
	g = 0;
	b = 0;
...
export class StringName implements VariantType {
	type = "stringname";
	constructor(public value: string) { }
}
export class NodePath implements VariantType {
	type = "nodepath";
	constructor(public names: StringName[], public subnames: StringName[], public absolute: boolean) { }
}
export class VariantRID implements VariantType {
	type = "variantrid";
	constructor(public value: number) { }
}
export class Callable implements VariantType {
	type = "callable";
}
...
export class Dictionary implements VariantType {
	type = "dictionary";
	value = new Map<VariantType, VariantType>()
}
...
export class PackedInt32Array implements VariantType {
	type = "packed_int32_array";
	value = new Int32Array();
}
export class PackedInt64Array implements VariantType {
	type = "packed_int64_array";
	value = new BigInt64Array();
}
export class PackedF32Array implements VariantType {
	type = "packed_float32_array";
	value = new Float32Array();
}
export class PackedF64Array implements VariantType {
	type = "packed_float64_array";
	value = new Float64Array();
}
export class PackedStringArray implements VariantType {
	type = "packed_string_array";
	value: String[] = [];
}
export class PackedVector2Array implements VariantType {
	type = "packed_vector2_array";
	value: Vector2[] = [];
}
export class PackedVector3Array implements VariantType {
	type = "packed_vector3_array";
	value: Vector3[] = [];
}
export class PackedColorArray implements VariantType {
	type = "packed_color_array";
	value: Color[] = [];
}
export class PackedVector4Array implements VariantType {
	type = "packed_vector4_array";
	value: Vector4[] = [];
}

const Variant = () => new Nil();
const bool_t = (v: number) => new Boolean(!!v);
const int_t = (v: number) => new Integer(v);
const int64_t = (v: bigint) => new Integer64(v);
const float_t = (v: number) => new Float(v);
const float64_t = (v: number) => new Float64(v)
const string_t = (v: string) => new String(v)
...
export function parse_variant(res: ResourceData, f: GodotReader, use_real64: boolean, ver_format: number, _get_string: () => string): VariantType {
	...
	switch (prop_type) {
		...
		case BIN.VARIANT_NODE_PATH: {
			const names: StringName[] = [];
			const subnames: StringName[] = [];
